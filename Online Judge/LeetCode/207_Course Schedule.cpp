...
bool bfs(int numCourses, vector<vector<int>> &graph, vector<int> &inDegree)
{
    queue<int> frontier;
...
bool topologicalSort(int numCourses, vector<vector<int>> &graph)
{
...
bool canFinish(int numCourses, vector<vector<int>> &prerequisites)
{
    ...
    for (auto prereq : prerequisites)
    {
        ...
        // inDegree[prereq[0]]++; // we can perform indegre here or we can calculate in topological function
    }
